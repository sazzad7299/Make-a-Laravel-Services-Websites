            ...
            <div class="panel-body">
                <form action="{{route('admin.settings')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="service_text" id="service_text" rows="5" class="form-control">{{$titles->service_text}}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="portfolio_text" id="portfolio_text" rows="5" class="form-control">{{$titles->portfolio_text}}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="testimonial_text" id="testimonial_text" rows="5" class="form-control">{{$titles->testimonial_text}}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="team_text" id="team_text" rows="5" class="form-control">{{$titles->team_text}}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="progress_text" id="progress_text" rows="5" class="form-control">{{$titles->progress_text}}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="blog_text" id="blog_text" rows="5" class="form-control">{{$titles->blog_text}}</textarea>
                    </div>
