                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a href="{{ route('admin.tag.edit', [$cat->id]) }}" class="btn btn-sm btn-primary mr-1"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                            <form action="{{ route('admin.tag.destroy', [$cat->id]) }}" class="mr-5 pull-left" method="POST">
                                                @method('DELETE')
                                                @csrf
